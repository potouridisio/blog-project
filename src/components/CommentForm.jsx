 ...
 */
export default function CommentForm({ initialValue, onSubmit, onCancelClick, onEscapeDown }) {
    ...
    <div className="flex w-full flex-col">
      ...
      {isEditing && isFocused ? (
        <p className="mr-2 mt-0.5 text-xs text-gray-500">
          Press Esc to{' '}
          <a className="text-blue-500 hover:underline" href="#" onClick={onCancelClick}>
            cancel
          </a>
          .
        </p>
      ) : isEditing ? (
        <a className="w-2 text-xs text-blue-500 hover:underline" href="#" onClick={onCancelClick}>
          Cancel
        </a>
      ) : null}
    </div>
